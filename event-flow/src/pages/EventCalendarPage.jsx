...
function EventCalendarContent({ eventDetail, eventId, organizationId, reloadKey, onError }) {
  ...
  const eventRangeTitle = `${formatDateTime(eventDetail?.startTime)} - ${formatDateTime(eventDetail?.endTime)}`
